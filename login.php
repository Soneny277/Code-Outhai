...
<head>
    ...
    <title>ເຂົ້າສູ່ລະບົບໂຮງແຮມອຸດົມຊັບເມືອງຮຸນແຂວງອຸດົມໄຊ</title>
            ...
            <div class="col-md-5">
                <div class="login-form">
                    <div class="text-center mb-4">
                        <h2><i class="fas fa-sign-in-alt text-primary me-2"></i>ເຂົ້າສູ່ລະບົບ</h2>
                        <p class="text-muted">ເຂົ້າສູ່ລະບົບເພື່ອຈອງຫ້ອງພັກ</p>
                    </div>
                    ...
                    <div class="text-center mt-3">
                        <p>ຍັງບໍ່ມີບັນຊີ? <a href="register.php" class="text-primary">ລົງທະບຽນ</a></p>
